...
const Menu = () => {
    ...
    return (
        <div className={`fixed z-10 h-[calc(100dvh-60px)] top-[60px] w-screen p-7 flex flex-col justify-between ${darkTheme ? "bg-dark" : "bg-light"} transition-colors duration-500`}>
